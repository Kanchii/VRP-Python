def init(_num_Veiculos, _num_Clientes, _capacidade_Veiculo, _coords, _demandas,
    ...
    global matriz_Distancia, clientes, capacidade_Veiculo, num_Veiculos, num_Clientes, deposito,\
           coords, demandas, time_Window, NUM_ITERACOES, NUM_PARTICLES

    deposito = Cliente(_coords[0], 0, _demandas[0], _time_Window[0])
