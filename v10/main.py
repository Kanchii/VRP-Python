...
def main():
    try:
        num_Clients, num_Vehicles, number_Type_Vehicles, vehicle_Each_Type_Model, clients, vehicles = Read_File().read_File("In/TWSPD/50C/IC101.txt", "In/In_Veiculos")

        Global._init(_num_Clients = num_Clients,_num_Vehicles = num_Vehicles, _number_Type_Vehicles = number_Type_Vehicles,
                     _vehicle_Each_Type_Model = vehicle_Each_Type_Model, _MAX_PARTICLES = 100, _MAX_ITERATION = 1000,
                     _clients = clients, _vehicles = vehicles)
